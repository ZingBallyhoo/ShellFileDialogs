...
namespace ShellFileDialogs.Native
{
    ...
    ///     &quot;All Win32 error codes MUST be in the range 0x0000 to 0xFFFF, although Win32 error codes can be used both in
    ///     16-bit fields (such as within the HRESULT type specified in section 2.1) as well as 32-bit fields.&quot;
    /// </remarks>
    internal enum Win32ErrorCodes : ushort
    {
	    /// <summary>
	    ///     <c>ERROR_SUCCESS = 0x0000 == 0</c>
	    /// </summary>
	    Success = 0,

	    /// <summary>
	    ///     <c>ERROR_CANCELLED = 0x000004C7 == 1223</c>
	    /// </summary>
	    ErrorCancelled = 1223
    }

    /// <summary>
    ///     Remember that HRESULT values are actually 32-bit packed structures which *encapsulate* 16-bit Win32 error
    ///     codes - and other error codes. Use the methods in <see cref="HResults" /> to correctly inspect a
    ///     <see cref="HResult" /> value.
    /// </summary>
