...
using ShellFileDialogs.Native.Properties;
...
#pragma warning disable 0108
    ...
    internal interface IShellItem2 : IShellItem
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void GetAttributes([In] ShellFileGetAttributesOptions sfgaoMask,
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void GetPropertyStoreForKeys([In] ref PropertyKey rgKeys, [In] uint cKeys, [In] GetPropertyStoreOptions Flags,
            [In] ref Guid riid, [Out] [MarshalAs(UnmanagedType.IUnknown)] out IntPtr ppv);
#endif
